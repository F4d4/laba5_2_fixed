...
import net.facility.*;
/**
 * Класс задания значений полей объекта
 */
public class Ask {
     ...
     */
    public static Ticket askTicket(Console console, long id) throws AskBreak {
        ...
        Event event = askEvent(console, id);
     ...
     */
    public static Event askEvent(Console console, long id) throws AskBreak {
